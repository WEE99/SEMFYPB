...
export default ({navigation, route}) => {
  ...
  const pressLogin =()=>{
    ...
    if(em === " "){
        ...
        auth.signInWithEmailAndPassword(LoginEmail, Loginpassword)
            .then((user) => {
                console.log("LoginPages user.user.uid: "+user.user.uid);
  ...
  return (
    ...
    <ImageBackground source={{uri: 'https://images.unsplash.com/photo-1562710057-b3a85fa9ba85?ixlib=rb-1.2.1&w=1000&q=80'}} style={styles.backgroundimage}>
