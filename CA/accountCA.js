      ...
      <ImageBackground source={require('./img/backgroundImg.png')} style={styles.bgimage}>
        ...
        <View style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)', marginLeft: 50, marginRight: 50, marginTop: 20, paddingBottom: 50, borderRadius: 10 }}>
          ...
          <View style={styles.UsernameContainer}>
            <Text style={styles.titleUsername}>Joo</Text>
            <Text style={styles.usersmallname}>Miss J</Text>
          </View>
            ...
            <View>
              ...
              <View style={styles.flexrow}>
                ...
                <View style={styles.userinfo}>
                  <Text style={styles.userdata}>0123456789</Text>
                </View>
              </View>
              ...
              <View style={styles.flexrow}>
                ...
                <View style={styles.userinfo}>
                  <Text style={styles.userdata}>missjoo123@gmail.com</Text>
                </View>
              </View>
              ...
              <View style={styles.flexrow}>
                ...
                <View style={styles.userinfo}>
                  <Text style={styles.userdata}>Company Admin</Text>
                </View>
              </View>
