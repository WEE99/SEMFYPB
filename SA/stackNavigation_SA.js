...
function ReportStackNav() {
  return (
    <ReportStack.Navigator navigationOptions="">
      ...
      />
      <ReportStack.Screen
        name="List of Salesperson"
        component={ListSalesperson}
        options={{ headerShown: false }}
      />
      <ReportStack.Screen
        name="List of Leads"
      ...
      />
      <ReportStack.Screen
        name="Salesperson Leads"
        component={SalespersonLeads}
      />
      <ReportStack.Screen name="Lead Detail" component={AccountLead} />
      <ReportStack.Screen
        name="Salesperson Account Detail"
        component={AccountSale}
      />
      <ReportStack.Screen
        name="Company Admin Account Detail"
        component={AccountCA}
      />
